...
Future<bool> show_confirmation_dialog(BuildContext context, String? tip) async {
  return await showDialog<bool>(
    context: context,
    builder: (BuildContext context) {
      return AlertDialog(
        title: Text('Warning'),
        content: Text(tip ?? 'Are you sure you want to perform this action?'),
        actions: <Widget>[
          TextButton(
            child: Text('Cancel'),
            ...
            children: [
              Row(
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () async {
                      bool confirmed = await show_confirmation_dialog(context, "You really want to delete this?");
                      if (confirmed) {
